...
const Contact = () => {
  ...
  const socialLinks = [
    { 
      name: 'LinkedIn', 
      href: 'http://www.linkedin.com/in/itsmeakashsharma', 
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social) => (
                    <a
                      key={social.name}
                      href={social.href}
                      className="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200 group"
                    >
